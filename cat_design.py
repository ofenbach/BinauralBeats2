...
class CatDesign:
    ...
    def __init__(self, ui, color_box='#131416', color_border='#26282C', color_bg='#0A0B0C',
    ...
    def divider(self, classes='mt-8 mb-8', style='background-color: #26282C'):
    ...
    def outline_button(self):
        ...
        .button_slide {
          color: #FFF;
          border: 1px solid rgba(12, 102, 228, 1);
          border-radius: 8px;
          padding: 16px 32px;
          font-size: 16px;
          cursor: pointer;
          box-shadow: inset 0 0 0 0 rgba(12, 102, 228, 1);
          -webkit-transition: ease-out 0.4s;
          -moz-transition: ease-out 0.4s;
          transition: ease-out 0.4s;
        }
        .slide_right:hover {
          box-shadow: inset 400px 0 0 0 rgba(14, 104, 255, 1);
        }
        """
    ...
    def card(self, img_src="", header="Heading", sub_header="Subheading"):
        ...
        with self.ui.element('div').classes('card'):

            with self.ui.row().classes('image_card_hover'):
